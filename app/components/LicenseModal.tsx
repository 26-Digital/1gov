...
import ApplicationForLicenseForm from "./ApplicationForLicenseForm";
...
const LicenseModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
                ...
                <div className="rounded-lg py-2 px-5 my-2 mr-2 shadow-lg w-full bg-white">
                  <div className="mx-0">
                    ...
                    <div className="w-full">
                      <ApplicationForLicenseForm onClose={onClose}/>
                    </div>
                </div>
            </div>
          </div>
