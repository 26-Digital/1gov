                                ...
                                <div className="flex space-x-2">
                                    ...
                                    <div>
                                        <div className="flex space-x-2">
                                            ...
                                            <Input id="CardNumber" type="text" className="w-full p-2 border rounded-md" />
                                        </div>
                                        
                                    </div>
                                    <div>
                                        <div className="flex space-x-2">
                                            <Label htmlFor="expiry_date">Card Number</Label>
                                            <Input id="expiryDate" type="text" className="w-full p-2 border rounded-md" />
                                        </div>
                                    </div>
                                    <div>
                                    <div className="flex space-x-2">
                                            <Label htmlFor="cvv">CVV</Label>
                                            <Input id="cvv" type="text" className="w-full p-2 border rounded-md" />
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
